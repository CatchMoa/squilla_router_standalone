...
Verbatim port of ``opensquilla.router_tiers`` for the standalone package.
"""
...
class TierConfig:
    ...
    def from_value(cls, value: object) -> TierConfig:
        ...
        ctx_window = _get("context_window")
        return cls(
            ...
            context_window=(int(ctx_window) if isinstance(ctx_window, (int, float)) and ctx_window else None),
        )
